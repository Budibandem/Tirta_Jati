        ...
        <div className="max-w-2xl mx-auto bg-white rounded-3xl border border-slate-200 p-8 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="border-t border-slate-100 pt-6 mb-8">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm text-slate-600 font-light">
              ...
              <div className="flex items-center gap-2"><svg className="w-4 h-4 text-[#7cb5c8]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg> Area Parkir</div>
